                                            ...
                                            {cliente.viagens.map(viagem => (
                                                <>
                                                    <tr key={viagem.id}>
                                                        ...
                                                        <td>
                                                            <button type="button" className="btn btn-sm border-light m-1" data-bs-toggle="modal" data-bs-target="#ModalA" onClick={(e) => callModal(viagem.id, cliente.id,"Alterar Viagem")}>
                                                                <img src="img/edit.png" alt="editar" />
                                                            </button>

                                                            <button type="button" className="btn btn-sm border-light m-1" data-bs-toggle="modal" data-bs-target="#ModalA" onClick={(e) => callModal(viagem.id, cliente.id , "Apagar Viagem")}>
