            ...
            {cliente && (
                <>
                        ...
                        <div className="col-12 col-sm-12 col-md-12 col-lg-6 mx-auto">
                            <div className="row mb-3">
                                ...
                                <div className="col-9 col-sm-9 col-md-9 col-lg-9 ">
                                    <input className="form-control text-white bg-transparent btn-outline-light" defaultValue={cliente.nome} readOnly={true} />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-3 col-sm-3 col-md-4 col-lg-6 border border-1 border-light rounded ">
                                    <label className="control-label text-white mt-1">Data de Nascimento:</label>
                                </div>
                                <div className="col-4 col-sm-4 col-md-4 col-lg-6">
                                    <input className="form-control text-white bg-transparent btn-outline-light" value={cliente.data_nascimento.substr(0, 10)} readOnly={true} />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-3 col-sm-3 col-md-3 col-lg-3 border border-1 border-light rounded ">
                                ...
                                <div className="col-6 col-sm-6 col-md-6 col-lg-6">
                                    <input className="form-control text-white bg-transparent btn-outline-light" value={cliente.cpf} readOnly={true} />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-3 col-sm-3 col-md-3 col-lg-3 border border-1 border-light rounded ">
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="submit" data-bs-save="modal" className="btn colorPurpleLigth border-light text-white" onClick={handleClick}>{title && (
