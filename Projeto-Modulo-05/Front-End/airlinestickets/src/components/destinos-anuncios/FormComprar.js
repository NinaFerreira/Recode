...
function FormComprar({ idViagem, titulo, title, preco }) {
    ...
    const handleClick = (e) => {
        e.preventDefault();
        setValor(document.getElementById("Valor").value);
                ...
                <>
                    <div className="row m-3">
                        <div className="col-12 col-sm-12 col-md-12 col-lg-6">
                            <div className="row mb-3">
                                ...
                                <div className="col-8 col-sm-8 col-md-8 col-lg-8 m-0">
                                    <input type="text" className="form-control text-white bg-transparent btn-outline-light" value={nome} readOnly={true} />
                                </div>
                            </div>
                            <div className="row mb-3">
                                ...
                                <div className="col-5 col-sm-5 col-md-4 col-lg-6">
                                    <input type="date" className="form-control bg-transparent colorPurple btn-outline-light text-white" id="data" defaultValue={data_nascimento} readOnly={true} />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-3 col-sm-3 col-md-3 col-lg-3 border border-1 border-light rounded ">
                                ...
                                <div className="col-8 col-sm-8 col-md-8 col-lg-8 m-0">
                                    <input type="text" className="form-control text-white bg-transparent btn-outline-light" value={cpf} readOnly={true} />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-3 col-sm-3 col-md-3 col-lg-3 border border-1 border-light rounded ">
                                ...
                                <div className="col-8 col-sm-8 col-md-8 col-lg-8 m-0">
                                    <input type="text" className="form-control text-white bg-transparent btn-outline-light" value={telefone} readOnly={true} />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-3 col-sm-3 col-md-3 col-lg-3 border border-1 border-light rounded ">
                                ...
                                <div className="col-8 col-sm-8 col-md-8 col-lg-8 m-0">
                                    <input type="text" className="form-control text-white bg-transparent btn-outline-light" id="Valor" value={valor} onChange={(e) => setValor(e.target.value)} readOnly={true} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 col-sm-12 col-md-12 col-lg-6">
                            <div className="row mb-3">
                                ...
                                <div className="col-8 col-sm-8 col-md-8 col-lg-8 m-0">
                                    <input type="text" className="form-control text-white bg-transparent btn-outline-light" value={title} onChange={(e) => setDestino(e.target.value)} readOnly={true} />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-3 col-sm-3 col-md-3 col-lg-3 border border-1 border-light rounded ">
                            ...
                            <div className="row mb-3">
                                <div className="col-4 col-sm-4 col-md-4 col-lg-4 py-1 border border-1 border-light rounded ">
                    ...
                    <div className="modal-footer  px-0 py-2">
                        <div className="form-group">
                            <button type="button" className="btn colorPurple border-light text-white me-2"
                                data-bs-dismiss="modal">
                                Sair
                            </button>
                            <button type="button" className="btn colorPurple border-light text-white me-2" onClick={Desconto}> Aplicar Desconto </button>
                            <button type="submit" onClick={handleClick} className="btn colorPurple border-light text-white">Comprar</button>
                        </div>
                    </div>
                </>
            )
