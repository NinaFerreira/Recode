...
function TabelaPacotesCl() {
    ...
    return (
        <>
            ...
            <table className="table colorPurple rounded-3 mt-2">
                <thead>
                    <tr>
                        <th>Nome</th>
                        <th>Origem</th>
                        ...
                        <>
                            {viagens.map(viagem =>
                                <tr key={viagem.id}>
                                    ...
                                    <td>
                                        <button type="button" className="btn btn-sm border-light" onClick={async (e)  => { callModal(viagem.id, "Cancelar Viagem") }} data-bs-toggle="modal" data-bs-target="#ModalCl" >
