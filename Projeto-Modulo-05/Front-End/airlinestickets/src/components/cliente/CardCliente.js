...
function CardCliente() {
    ...
    return (
        ...
        <div className="row justify-content-center text-break text-center rounded py-3" >
            ...
            <div className="col-7">
                <div className="card p-0 colorPurple rounded">
                    {cliente && (
                        <>
                            <img className="card-img-top img-img-fluid my-2 w-50 border rounded-pill m-auto" src="/img/adicionar-usuario.png" alt="Imagem de capa do card" />
                            <div className="card-body colorPurple text-start">
                            ...
                            <div className="card-body colorPurple">
                                <button type="button" className="btn btn-sm border-light mx-3 w-25" onClick={(e) => { callModal(cliente.id, "Alterar Dados") }} data-bs-toggle="modal" data-bs-target="#ModalCl">
                                    <img src="/img/edit.png" alt="edit" className="w-75 h-75 my-auto" />
                                </button>

                                <button type="button" className="btn btn-sm border-light mx-3 w-25" onClick={(e) => { callModal(cliente.id, "Apagar Dados") }} data-bs-toggle="modal" data-bs-target="#ModalCl" >
