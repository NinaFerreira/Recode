            ...
            <div className="row justify-content-center">
                <div className="col-12 col-sm-12 col-md-12 col-lg-6 mx-auto">
                    ...
                    <div className="form-group mb-3">
                        <div className="row">
                            <div className="col-4 col-sm-4 col-md-4 col-lg-3 border border-1 border-light rounded">
                            ...
                            <div className="col-8 col-sm-8 col-md-8 col-lg-9">
                                <input type="text"
                                    className="form-control bg-transparent btn-outline-light text-white" defaultValue={nome} onChange={(e) => setNome(e.target.value)} readOnly={read}/>
                            </div>
                        </div>
                    </div>
                    <div className="form-group mb-3">
                        <div className="row">
                            ...
                            <div className="col-5 col-sm-5 col-md-4 col-lg-6">
                                <input type="date" className="form-control bg-transparent btn-outline-light text-white" id="data" defaultValue={data_nascimento} onChange={(e) => { setDataNascimento(e.target.value)}} readOnly={read}/>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-8 col-sm-8 col-md-8 col-lg-9">
                                <input type="number" min="10000000000" max="99999999999"
                                    className="form-control bg-transparent btn-outline-light text-white" value={cpf} onChange={(e) => setCPF(e.target.value)} readOnly={read}/>
                            </div>
                        </div>
                    </div>
                    <div className="form-group mb-3">
                        <div className="row">
                            ...
                            <div className="col-8 col-sm-8 col-md-6 col-lg-9">
                                <input type="tel" className="form-control bg-transparent btn-outline-light text-white" defaultValue={telefone} onChange={(e) => setTelefone(e.target.value)} readOnly={read}/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="form-group mt-3">
                <div className="row justify-content-center">
                    <div className="col-10 col-sm-6 col-md-4 col-lg-3">
                        <button className="btn w-100 btn-lg colorPurple border-light text-white" onClick={validarCadastro}>
                            {titulo ? (
