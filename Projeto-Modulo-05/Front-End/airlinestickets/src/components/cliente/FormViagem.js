                ...
                <>
                    <div className="row m-3">
                        <div className="col-12 col-sm-12 col-md-12 col-lg-6">
                            <div className="row mb-3">
                                <div className="col-3 col-sm-3 col-md-3 col-lg-3 border border-1 border-light rounded ">
                                    <label className="control-label text-white mt-1">Nome: </label>
                                </div>
                                <div className="col-8 col-sm-8 col-md-8 col-lg-8 m-0">
                                    <input type="text" className="form-control text-white bg-transparent btn-outline-light" value={cliente.nome} readOnly={true} />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-4 col-sm-4 col-md-4 col-lg-6 border border-1 border-light rounded ">
                                    <label className="control-label mt-1">Data de Nascimento:</label>
                                </div>
                                <div className="col-5 col-sm-5 col-md-4 col-lg-6">
                                    <input type="date" className="form-control bg-transparent btn-outline-light text-white" id="data" value={cliente.data_nascimento} readOnly={true} />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-3 col-sm-3 col-md-3 col-lg-3 border border-1 border-light rounded ">
                                ...
                                <div className="col-8 col-sm-8 col-md-8 col-lg-8 m-0">
                                    <input type="text" className="form-control text-white bg-transparent btn-outline-light" value={cliente.cpf} readOnly={true} />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-3 col-sm-3 col-md-3 col-lg-3 border border-1 border-light rounded ">
                                ...
                                <div className="col-8 col-sm-8 col-md-8 col-lg-8 m-0">
                                    <input type="text" className="form-control text-white bg-transparent btn-outline-light" value={cliente.telefone} readOnly={true} />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-3 col-sm-3 col-md-3 col-lg-3 border border-1 border-light rounded ">
                                ...
                                <div className="col-8 col-sm-8 col-md-8 col-lg-8 m-0">
                                    <input type="text" className="form-control text-white bg-transparent btn-outline-light" id="Valor" value={viagem.valor} readOnly={true} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 col-sm-12 col-md-12 col-lg-6">
                            <div className="row mb-3">
                                ...
                                <div className="col-8 col-sm-8 col-md-8 col-lg-8 m-0">
                                    <input type="text" className="form-control text-white bg-transparent btn-outline-light" value={viagem.destino} readOnly={true} />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-3 col-sm-3 col-md-3 col-lg-3 border border-1 border-light rounded ">
                                ...
                                <div className="col-8 col-sm-8 col-md-8 col-lg-8 m-0">
                                    <input type="text" className="form-control text-white bg-transparent btn-outline-light" value={viagem.origem} readOnly={true} />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-3 col-sm-3 col-md-3 col-lg-3 border border-1 border-light rounded ">
                                ...
                                <div className="col-7 col-sm-7 col-md-7 col-lg-7 m-0">
                                    <input type="date" className="form-control text-white bg-transparent btn-outline-light" value={viagem.data_ida} readOnly={true} />
                                </div>
                            </div>
                            <div className="row mb-3" id="volta">
                                <div className="col-4 col-sm-4 col-md-4 col-lg-4 border border-1 border-light rounded">
                                    <label className="control-label text-white mt-1">Data Volta: </label>
                                </div>
                                <div className="col-7 col-sm-7 col-md-7 col-lg-7 m-0">
                                    <input type="date" className="form-control text-white bg-transparent btn-outline-light" value={viagem.data_volta} readOnly={true} />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="modal-footer px-0 py-2">
                        <div className="form-group">
                            <button type="button" className="btn colorPurpleLigth border-light text-white me-2"
                                data-bs-dismiss="modal">
                                Sair
                            </button>
                            <input type="submit" value="Cancelar Viagem" onClick={handleClick} className="btn colorPurpleLigth border-light text-white" data-bs-dismiss="modal" />
                        </div>
                    </div>
                </>
            )
