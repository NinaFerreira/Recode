        ...
        <div className="row mx-5">
            ...
            <form>
                ...
                <div className="form-floating mb-3">
                    <input className="form-control bg-transparent btn-outline-light text-white" type="password" onChange={(e) => { setPassword(e.target.value) }} />
                    <label className="form-label">Nova senha</label>
                </div>
                <div className="form-floating mb-3">
                    <input className="form-control bg-transparent btn-outline-light text-white" type="password" onChange={(e) => { setConfirmPassword(e.target.value) }} />
                    <label className="form-label">Confirmar </label>
                </div>
                <button type="submit" className="w-100 btn colorPurple border-light text-white" onClick={alterarPassword}>Alterar senha</button>
            </form>
        </div>
    )
}
