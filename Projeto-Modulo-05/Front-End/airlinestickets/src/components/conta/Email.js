        ...
        <div className="row mx-5">
            ...
            <form>
                ...
                <div className="form-floating input-group mb-3">
                    {user && (
                        <input className="form-control bg-transparent btn-outline-light text-white" readOnly={true} value={user.email} type="email" />
                    )}
                ...
                <div className="form-floating mb-3">
                    <input className="form-control  bg-transparent btn-outline-light text-white" onChange={(e) => {setEmail(e.target.value)}} type="email" />
                    <label className="form-label">Novo Email</label>
                </div>
                <button type="submit" className="btn w-100 text-white colorPurple border-light" onClick={alterarEmail}>Alterar e-mail</button>
            </form>
