        ...
        <div className="col-12 col-sm-12 col-md-5 col-lg-5 shadow rounded py-3 m-2">
            ...
            <div className="row">
                ...
                <div className="col-6 col-md-6 col-sm-6 col-lg-6 mx-auto text-break">
                    ...
                    <p><MdAlternateEmail/> AirlinesTickets@email.com</p>
                    <p><FaFacebook/> Facebook.com/AirlinesTickets</p>
                    <p><FaTwitter/> Twitter.com/AirlinesTickets</p>
                    <p><FaInstagram/> Instagram.com/AirlinesTickets</p>
                </div>
            </div>
        </div>
    )
