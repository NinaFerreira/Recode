                ...
                <table className="table">
                    ...
                    {contatos.map(contato  => (
                            <tr key={contato.id}>
                                ...
                                <td>
                                    <button type="button" className="btn btn-sm m-1" data-bs-toggle="modal" data-bs-target="#ModalA" onClick={(e) => callModal(contato.id, "Alterar Contato")}>
                                        <img src="img/edit.png" alt="editar" />
                                    </button>

                                    <button type="button" className="btn btn-sm m-1" data-bs-toggle="modal" data-bs-target="#ModalA" onClick={(e) => callModal(contato.id, "Apagar Contato")}>
