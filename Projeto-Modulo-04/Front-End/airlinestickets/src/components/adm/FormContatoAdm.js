        ...
        <form>
            <div className="row m-3">
                <div className="col-12 col-sm-12 col-md-5 col-lg-5 mx-auto">
                    <div className="form-group mb-3">
                        <div className="row">
                            <div className="col-3 col-sm-3 col-md-4 col-lg-3 border border-1  rounded ">
                    ...
                    <div className="form-group mb-3">
                        <div className="row">
                            <div className="col-2 col-sm-2 col-md-4 col-lg-3 border border-1  rounded ">
            ...
            <div className="form-group mt-3">
                <div className="modal-footer">
                    ...
                    <button type="submit" data-bs-save="modal" onClick={handleClick} className="btn colorPurple text-white">{title && (
